...
{
    ShaderOld_Vulkan::~ShaderOld_Vulkan()
    {
        if (isValid())
        {
            onShaderPreClear();
    ...
    bool ShaderOld_Vulkan::initInternal(const jstring& shaderName, const jmap<jstring, ShaderUniform>& uniforms)
    {
    ...
    void ShaderOld_Vulkan::createShaderModules(const jstring& shaderName)
    {
    ...
    void ShaderOld_Vulkan::createShaderModule(const jstring& fileName, const ShaderStage stage)
    {
    ...
    bool ShaderOld_Vulkan::createDescriptorSetLayout(const jmap<jstring, ShaderUniform>& uniforms)
    {
    ...
    bool ShaderOld_Vulkan::createPipelineLayout()
    {
    ...
    void ShaderOld_Vulkan::createPipelineStageInfos()
    {
    ...
    void ShaderOld_Vulkan::clearVulkanData()
    {
